...
return (
    <div className='container'>
      ...
      <div className='item-div'>
        <p className='menu-title'>{itemCount > 9 ? 
          <p >Sorry, the items list is currently full</p>: 
            enabled ? <p className='add-item'>Add an Item</p> : 
          <p>Sorry, you can only add items between 7-8 am</p>}
        </p>
      </div> 
